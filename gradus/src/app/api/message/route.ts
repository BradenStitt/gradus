...
export const POST = async (req: NextRequest) => {
  ...
  const response = await openai.chat.completions.create({
    ...
    messages: [
      ...
      {
        role: "user",
        content: `**Use the following pieces of context (or previous conversation if needed) to generate an artificial grade out of 100 for my essay based on the provided rubric. Do this in markdown format.**
